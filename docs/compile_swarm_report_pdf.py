"""
Compile Drone Swarm Telemetry Testbed Experimental Report to PDF
================================================================
Uses Playwright and Microsoft Edge to compile `swarm_telemetry_experimental_report.html`
into `Swarm_Telemetry_Experimental_Report.pdf` with MathJax vector SVG typography.
"""
...
def compile_swarm_report():
    ...
    with sync_playwright() as p:
        ...
        page.pdf(
            ...
            margin={"top": "8mm", "bottom": "10mm", "left": "11mm", "right": "11mm"}
        )
        browser.close()
